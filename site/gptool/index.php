...
<html lang="en">
    <head>
        ...
        <title>GPTool - iPayment Guides</title>
...
<li >
    <a href="../schema/campaigns/schema/">Schema</a>
            ...
            <ul class="nav navbar-nav navbar-right">
                <li>
                    ...
                    <li >
                        <a rel="next" href="../dev-service/">
                            <i class="fa fa-arrow-left"></i> Previous
                        </a>
                    </li>
                    <li >
                        <a rel="prev" href="../schema/campaigns/schema/">
    ...
    <ul class="nav bs-sidenav">
        <li class="main active"><a href="#ipayment-gptool">iPayment: GPTool</a></li>
...
<h1 id="ipayment-gptool">iPayment: GPTool</h1>
